...
model_names = sorted(name for name in svhn_models.__dict__
                     if name.islower() and not name.startswith("__")
                     and callable(svhn_models.__dict__[name]))
...
def main_worker(gpu, args):
    ...
    try:
        model = svhn_models.__dict__[args.arch](pretrained=args.pretrained)
    except KeyError:
    ...
    train_dataset = torchvision.datasets.SVHN(root='/home/heyintao/dataset/SVHN/',split='train', transform=transform, download=True)
    test_dataset = torchvision.datasets.SVHN(root='/home/heyintao/dataset/SVHN/',split='test', transform=transform, download=True)
